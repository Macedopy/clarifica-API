...
public class EletricExecutedServiceService {
    ...
    public void saveAll(List<ExecutedServiceDTO> dtos, String phaseId) {
        ...
        for (ExecutedServiceDTO dto : dtos) {
            EletricExecutedService entity = mapDtoToEntity(dto);
    ...
    private EletricExecutedService mapDtoToEntity(ExecutedServiceDTO dto) {
        EletricExecutedService entity = new EletricExecutedService();

        // Tratamento de nulos/vazios já que removemos @NotBlank
        entity.setName(
